...
export const columns: ColumnDef<OrderType>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <div className={cn(`p-1 rounded-md w-max text-xs`, status === "pending" && "bg-yellow-500/40", status === "success" && "bg-green-500/40", status === "failed" && "bg-red-500/40")}>{status as string}</div>;
    },
  },
  {
    accessorKey: "amount",
